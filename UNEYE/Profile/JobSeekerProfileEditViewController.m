//
//  JobSeekerProfileEditViewController.m
//  UNEYE
//
...
@interface JobSeekerProfileEditViewController ()<UINavigationControllerDelegate, UIImagePickerControllerDelegate, InformationCellDelegate, AddMoreTypeOfCareTableViewCellDelegate, AddMoreProfessionalInfoTableViewCellDelegate, CalendercellDelegate, ProfileSignUpBtnCellDelegate, EducationsCustomCellDelegate>{
...
@implementation JobSeekerProfileEditViewController
...
-(void)setAllKeyValuesParameters{
    ...
    if (tempSelectedDateArr.count > 0) {
        [updatedDataDict setValue:[self getCommaSeparateString] forKey:@"available_dates"];
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 0){
        ...
        cell.txtTypeOfCareRate.tag = indexPath.row;
        cell.txtAreaOfSkill.tag = indexPath.row;
        cell.txtAreaOfSkillRate.tag = indexPath.row;
        cell.txtStudyLevel.tag = indexPath.row;
        cell.txtStudyLevelRate.tag = indexPath.row;
        ...
        if ([[arrProfessionalInfo objectAtIndex:indexPath.row] valueForKey:@"typeofcare"] != nil) {
            ...
            cell.txtTypeOfCare.selectedItem = @"";
        }
        ...
        if ([[arrProfessionalInfo objectAtIndex:indexPath.row] valueForKey:@"areaofskill"] != nil) {
            ...
            cell.txtAreaOfSkill.selectedItem = @"";
        }
        ...
        if ([[arrProfessionalInfo objectAtIndex:indexPath.row] valueForKey:@"areaofstudy"] != nil) {
            ...
            cell.txtStudyLevel.selectedItem = @"";
        }
